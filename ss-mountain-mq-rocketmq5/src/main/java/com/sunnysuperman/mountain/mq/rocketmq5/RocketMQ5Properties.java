...
public class RocketMQ5Properties {
	...
	private List<RocketMQ5QueueProperties> queues;
	...
	public void validate() {
		...
		queues.forEach(RocketMQ5QueueProperties::validate);
	}

	@Override
	public String toString() {
		RocketMQ5Properties p;
		try {
	...
	public List<RocketMQ5QueueProperties> getQueues() {
		return queues;
	}

	public void setQueues(List<RocketMQ5QueueProperties> queues) {
		this.queues = queues;
	}
